...
public class JdbcOrderRepository implements OrderRepository {
    ...
    public TacoOrder save(TacoOrder order) {
        try {
            ...
            if (orderId == null) {
                throw new IllegalStateException("Failed to retrieve generated key for TacoOrder");
            }
            ...
            // Логируйте ошибку
            throw new RuntimeException("Failed to save TacoOrder", e);
        }
    }
    ...
    private long saveTaco(Long orderId, int orderKey, Taco taco) {
        ...
        PreparedStatementCreatorFactory pscf = new PreparedStatementCreatorFactory("insert into Taco " +
                "(name, created_at, taco_order, taco_order_key) " + "values (?, ?, ?, ?)", Types.VARCHAR,
                Types.TIMESTAMP, Type.LONG, Type.LONG);
        pscf.setReturnGeneratedKeys(true);
